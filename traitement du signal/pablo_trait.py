...
class Encoding:
    ...
    def spectrogram(self, fs, s):
        ...
        if len(s.shape) > 1 and s.shape[1] > 1:
            s = np.mean(s, axis=1) #stéréo en mono
...
if __name__ == '__main__':
    ...
    filename = 'C:/Users/thoum/Groupe_1_7_Optimisation/traitement du signal/samples/' + str(song) + '.wav'
...
if __name__ == '__main__':
    ...
    filename = 'C:/Users/thoum/Groupe_1_7_Optimisation/traitement du signal/secret_sample.wav'
